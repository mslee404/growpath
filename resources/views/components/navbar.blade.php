...
<nav class="w-full bg-[#78A44C] px-8 py-3 shadow-md font-lexend z-50 relative">
    <div class="flex justify-between items-center w-full">
        ...
        <button id="hamburger-btn" class="lg:hidden text-[#FDFDD9] focus:outline-none">
        ...
        {{-- LINKS MENU --}}
        {{-- Desktop: flex | Mobile: Absolute/Hidden --}}
        <div id="nav-menu" class="hidden lg:flex flex-col lg:flex-row absolute lg:relative top-full left-0 w-full lg:w-auto bg-[#78A44C] lg:bg-transparent p-6 lg:p-0 gap-2 items-start lg:items-center shadow-lg lg:shadow-none z-40">
            
            @php
                $baseClass = "flex items-center space-x-2 px-5 py-2.5 rounded-3xl transition-all duration-200 ease-out w-full lg:w-auto";
