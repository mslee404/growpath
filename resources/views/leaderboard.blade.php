<x-layout>
    ...
    <div class="max-w-6xl mx-auto px-4 md:px-8 py-8 pb-12">

        <h1 class="text-4xl font-black text-center text-[#5E7153] mb-8 uppercase tracking-wide">
            Leaderboard
        </h1>

        <div class="bg-[#FDFDD9] rounded-2xl shadow-xl p-5 md:p-6">
            ...
            <div class="flex flex-col lg:flex-row gap-8 items-center lg:items-end">
                ...
                <div class="w-full lg:w-1/2 flex justify-center items-end gap-3 lg:gap-4 order-1 lg:order-none">
                    ...
                    <div class="w-1/3 relative flex flex-col items-center">
                        <div class="w-full bg-[#C9D8BF] rounded-t-xl shadow-lg h-[220px] md:h-[300px] flex flex-col justify-start p-3 pt-10 items-center relative">
                            ...
                            <img src="https://placehold.co/112x112/E4E4E7/71717A?text=M" alt="Avatar" class="w-16 h-16 md:w-24 md:h-24 rounded-full border-4 border-white shadow-md mb-2 object-cover">
                    ...
                    <div class="w-1/3 relative flex flex-col items-center z-10">
                        <div class="w-full bg-[#C9D8BF] rounded-t-xl shadow-xl h-[260px] md:h-[370px] flex flex-col justify-start p-3 pt-12 items-center relative">
                            ...
                            <img src="https://placehold.co/128x128/E4E4E7/71717A?text=R" alt="Avatar" class="w-20 h-20 md:w-28 md:h-28 rounded-full border-4 border-white shadow-md mb-3 object-cover">
                    ...
                    <div class="w-1/3 relative flex flex-col items-center">
                        <div class="w-full bg-[#C9D8BF] rounded-t-xl shadow-lg h-[180px] md:h-[250px] flex flex-col justify-start p-3 pt-10 items-center relative">
                            ...
                            <img src="https://placehold.co/96x96/E4E4E7/71717A?text=G" alt="Avatar" class="w-14 h-14 md:w-20 md:h-20 rounded-full border-4 border-white shadow-md mb-2 object-cover">
                            <span class="font-bold text-sm md:text-lg text-center text-gray-800 mt-auto">200k xp</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-4 order-2 lg:order-none">
                    ...
                    <div class="flex items-center justify-between bg-[#FEFEF9] rounded-xl shadow-sm border border-gray-200 p-3">
