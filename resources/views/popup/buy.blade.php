{{-- resources/views/popup/buy.blade.php --}}
...
<div id="modal-buy" class="fixed inset-0 flex items-center justify-center z-50 opacity-0 invisible transition-opacity duration-300 ease-in-out">
    ...
    <div id="modal-content-buy" class="relative bg-[#9CB65C] rounded-3xl shadow-2xl w-full max-w-lg p-6 transform scale-95 transition-all duration-300 ease-in-out">
        ...
        <button id="close-buy" class="absolute top-5 right-6 text-white hover:text-gray-200 transition z-10">
        ...
        <div class="flex justify-center gap-6 mb-4">
            <button id="btn-cancel-buy" class="bg-[#FDFDE0] text-[#5C6843] font-bold text-lg px-6 py-3 rounded-xl shadow-md hover:bg-white transition transform hover:-translate-y-1">
                Ga jadi deh
            </button>
